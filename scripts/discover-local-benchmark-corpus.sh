...

{
  ...
  printf 'export MICRORAPTOR_GAUNTLET_CORPUS_INPUTS=%q\n' "${recommended_inputs[*]}"
  printf 'export MICRORAPTOR_GAUNTLET_CORPUS_PAIRED_INPUTS=%q\n' "${recommended_pairs[*]}"
} > "${env_file}"

{
  ...
  printf 'export MICRORAPTOR_GAUNTLET_CORPUS_INPUTS=\n'
  printf 'export MICRORAPTOR_GAUNTLET_CORPUS_PAIRED_INPUTS=%q\n' "${independent_pairs[*]}"
...

{
  ...
  printf 'export MICRORAPTOR_GAUNTLET_CORPUS_PAIRED_INPUTS="${MICRORAPTOR_GAUNTLET_CORPUS_PAIRED_INPUTS:-} %s"\n' "${larger_pairs[*]}"
} > "${larger_env_file}"
